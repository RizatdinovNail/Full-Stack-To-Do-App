...
export default function NavBar({
  ...
  const links = [
    {
      name: activeView === "profile" ? "Main page" : "Profile",
  ...
  return (
    <nav className="flex justify-between px-4 items-center">
      ...
      >
        ...
        <section
          className={`absolute bg-(--button) rounded-xl ${navSection ? "block" : "hidden"} top-14 w-34 right-0`}
        >
